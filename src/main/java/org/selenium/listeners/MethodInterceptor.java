		...
		for (IMethodInstance method : methods) {
			...
			for (String group : testMethod.groups()) {
			 ...
			 if (groups.contains("SMOKE")) {
				 System.out.println(
							"SMOKE Either You are not running the test execution from Maven"
							+ " command line or you are not giving the property -D=testCategory");
					return methods;
			 }
			 if (groups.contains("SANITY")) {
				 System.out.println(
							"SANITY Either You are not running the test execution from Maven"
							+ " command line or you are not giving the property -D=testCategory");
					return methods;
			 }
			 if (groups.contains("BVT")) {
				 System.out.println(
							"BVT Either You are not running the test execution from Maven"
							+ " command line or you are not giving the property -D=testCategory");
					return methods;
			 }
